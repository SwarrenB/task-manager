...
<head>
    ...
    <meta charset="UTF-8"/>
    <title>Task Manager - Journals</title>
</head>
...
<div class="modal">
    ...
    <table class="table_sort">
        <caption style="font-family: 'Odibee Sans', cursive">JOURNALS</caption>
        <thead>
        <tr>
            <th style="cursor:default">
                <input type="checkbox" id="generalCheckbox" onchange="setCheck()">
            <th style="width: 300px; height: 100px;" title="Click this button to sort by this column">Name</th>
